-- Up Migration
DROP TRIGGER IF EXISTS set_timestamp_feature_votes ON public.feature_votes;
DROP TRIGGER IF EXISTS set_timestamp_feature_requests ON public.feature_requests;

DROP INDEX IF EXISTS public.feature_votes_feature_user_unique;
