...
function StoryEditForm(_a) {
  ...
  const handleTitleKeyDown = function (e) {
    if (e.key === 'Enter') {
      e.preventDefault()
        ...
        (0, jsx_runtime_1.jsxs)('div', {
          ...
          children: [
            ...
            (0, jsx_runtime_1.jsx)(input_1.Input, {
              ...
              disabled: isSaving,
              className:
                'text-2xl md:text-2xl font-display text-foreground h-auto py-2 px-0 border-0 border-none rounded-none focus-visible:ring-0 focus-visible:border-0 focus:border-0 focus:ring-0 bg-transparent shadow-none',
            }),
          ],
        }),
            ...
            (0, jsx_runtime_1.jsxs)('div', {
              ...
              children: [
                ...
                (0, jsx_runtime_1.jsx)(button_1.Button, {
                  variant: 'ghost',
                  onClick: onArchive,
                  children: (0, jsx_runtime_1.jsx)(lucide_react_1.Archive, {
                    className: 'h-4 w-4',
                  }),
                }),
              ],
