...
const story_card_1 = require('./story-card')
function StoryList(_a) {
  const _this = this
  const stories = _a.stories,
    orgName = _a.orgName,
    repoName = _a.repoName,
    onStoriesChange = _a.onStoriesChange
  const trpc = (0, trpc_1.useTRPCClient)()
  const _b = (0, react_1.useState)(new Set()),
    selectedIds = _b[0],
    setSelectedIds = _b[1]
  ...
  const _d = (0, react_1.useState)(false),
    isBulkActionLoading = _d[0],
    setIsBulkActionLoading = _d[1]
      ...
      const handleKeyDown = function (e) {
        ...
        if (e.key === 'ArrowDown') {
          ...
          if (
            ...
            const storyId_1 = stories[focusedIndex].id
  ...
  ;(0, react_1.useEffect)(
    function () {
      ...
      if (focusedIndex !== null && itemRefs.current[focusedIndex]) {
        ;(_a = itemRefs.current[focusedIndex]) === null || _a === void 0
          ? void 0
          : _a.focus()
      }
    },
  ...
  const handleToggleSelection = (0, react_1.useCallback)(function (storyId) {
    setSelectedIds(function (prev) {
      const next = new Set(prev)
      if (next.has(storyId)) {
        next.delete(storyId)
  ...
  const handleBulkPause = (0, react_1.useCallback)(
    function () {
          ...
          switch (_a.label) {
            ...
            case 2:
              ...
              sonner_1.toast.success(
                'Paused '
                  .concat(selectedIds.size, ' ')
                  .concat(selectedIds.size === 1 ? 'story' : 'stories'),
              )
              setSelectedIds(new Set())
              onStoriesChange === null || onStoriesChange === void 0
                ? void 0
                : onStoriesChange()
              return [3 /*break*/, 5]
            case 3:
  ...
  if (stories.length === 0) {
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
      children: [
        ...
        (0, jsx_runtime_1.jsx)(EmptyState_1.EmptyState, {
          kanji: '\u3055\u304F\u305B\u3044',
          ...
          action: (0, jsx_runtime_1.jsx)('div', {
    ...
    children: [
      hasSelection &&
        (0, jsx_runtime_1.jsxs)('div', {
          className:
            'sticky top-0 z-10 bg-background border-b px-4 py-2 flex items-center justify-between gap-2',
          children: [
            ...
            (0, jsx_runtime_1.jsxs)('div', {
              ...
              children: [
                ...
                (0, jsx_runtime_1.jsxs)(button_1.Button, {
                  ...
                  disabled: isBulkActionLoading,
                  children: [
                    (0, jsx_runtime_1.jsx)(lucide_react_1.Archive, {
                      className: 'h-4 w-4 mr-1',
                    }),
                    'Archive',
                  ],
          ...
          return (0, jsx_runtime_1.jsx)(
            'li',
            {
              children: (0, jsx_runtime_1.jsx)('div', {
                ...
                children: (0, jsx_runtime_1.jsx)(story_card_1.StoryCard, {
                  id: story.id,
                  name: story.name,
                  href: '/org/'
                    .concat(orgName, '/repo/')
                  ...
                  onToggleSelection() {
                    return handleToggleSelection(story.id)
                  },
                }),
              }),
            },
