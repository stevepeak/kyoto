...
function useStoryGeneration(_a) {
    var setIsGenerating = _a.setIsGenerating, setGenerationRunId = _a.setGenerationRunId, setGenerationAccessToken = _a.setGenerationAccessToken, setStoryContent = _a.setStoryContent, setStoryName = _a.setStoryName, setError = _a.setError;
    // Extract story from output and update state
    var handleStoryOutput = (0, react_1.useCallback)(function (output) {
        if ((output === null || output === void 0 ? void 0 : output.stories) && output.stories.length > 0) {
            var generatedStory = output.stories[0];
    ...
    var handleGenerationComplete = (0, react_1.useCallback)(function (output) {
        if (output) {
