...
const story_archive_dialog_1 = require('@/components/features/stories/story-archive-dialog')
const story_create_form_1 = require('@/components/features/stories/story-create-form')
const story_templates_dialog_1 = require('@/components/features/stories/story-templates-dialog')
const layout_1 = require('@/components/layout')

const StoryGenerationTracking_1 = require('./components/StoryGenerationTracking')
const StoryLoaderTabs_1 = require('./components/StoryLoaderTabs')
const useStoryActions_1 = require('./hooks/useStoryActions')
const useStoryGeneration_1 = require('./hooks/useStoryGeneration')
const useStoryLoaderState_1 = require('./hooks/useStoryLoaderState')
function StoryLoaderClient(_a) {
  const orgName = _a.orgName,
    repoName = _a.repoName,
    storyId = _a.storyId,
    initialStory = _a.initialStory
  const isCreateMode = !storyId
  // State management
  const state = (0, useStoryLoaderState_1.useStoryLoaderState)({ initialStory })
  // Actions
  const actions = (0, useStoryActions_1.useStoryActions)({
    orgName,
    repoName,
    storyId,
    isCreateMode,
  ...
  // Generation logic
  const generation = (0, useStoryGeneration_1.useStoryGeneration)({
    setIsGenerating: state.setIsGenerating,
    setGenerationRunId: state.setGenerationRunId,
    setGenerationAccessToken: state.setGenerationAccessToken,
    setStoryContent: state.setStoryContent,
    ...
    children: [
      ...
      state.error &&
        (0, jsx_runtime_1.jsx)('div', {
          className:
            'mx-6 mt-4 p-3 text-sm text-destructive bg-destructive/10 rounded-md',
      ...
      isCreateMode || state.story
        ? (0, jsx_runtime_1.jsx)('div', {
            ...
            children: (0, jsx_runtime_1.jsx)('div', {
              ...
              children: !isCreateMode
                ? (0, jsx_runtime_1.jsx)(StoryLoaderTabs_1.StoryLoaderTabs, {
                    story: state.story,
                    storyName: state.storyName,
                    storyContent: state.storyContent,
                    ...
                    onArchive() {
                      return state.setShowArchiveDialog(true)
                    },
                    onPause() {
                      return actions.handleToggleState('paused')
                    },
                ...
                : (0, jsx_runtime_1.jsx)(story_create_form_1.StoryCreateForm, {
                    storyContent: state.storyContent,
                    createMore: state.createMore,
                    isSaving: state.isSaving,
                    ...
                    onCancel: actions.handleCancel,
                    onTemplates() {
                      return state.setShowTemplatesDialog(true)
                    },
        ...
        : null,
      (0, jsx_runtime_1.jsx)(story_templates_dialog_1.StoryTemplatesDialog, {
      ...
      (0, jsx_runtime_1.jsx)(story_archive_dialog_1.StoryArchiveDialog, {
      ...
      (0, jsx_runtime_1.jsx)(
        StoryGenerationTracking_1.StoryGenerationTracking,
        {
