...
const useRepoSearch_1 = require('./hooks/useRepoSearch')
function ConnectRepoDialog(_a) {
  ...
  const _b = (0, react_1.useState)(''),
    searchQuery = _b[0],
    setSearchQuery = _b[1]
  const _c = (0, react_1.useState)(null),
    selectedRepoName = _c[0],
    setSelectedRepoName = _c[1]
  ...
  const _e = (0, react_1.useState)([]),
    allRepos = _e[0],
    setAllRepos = _e[1]
  const _f = (0, react_1.useState)(false),
    loadingRepos = _f[0],
    setLoadingRepos = _f[1]
  const loadRepos = (0, react_1.useCallback)(
    function () {
      return __awaiter(_this, void 0, void 0, function () {
        let data, reposList, error_1
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                trpc.repo.listByOrg.query({ orgName: org.slug }),
              ]
            case 2:
              data = _a.sent()
              reposList = data.repos.map(function (repo) {
                return {
                  id: repo.id,
                  name: repo.name,
  ...
  const filteredRepos = (0, useRepoSearch_1.useRepoSearch)(
    allRepos,
    searchQuery,
  ...
  const handleEnableRepo = function () {
    return __awaiter(_this, void 0, void 0, function () {
      let error_2
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            _a.sent()
            router.push(
              '/org/'.concat(org.slug, '/repo/').concat(selectedRepoName),
            )
            return [3 /*break*/, 5]
          case 3:
            error_2 = _a.sent()
  ...
  const handleOpenChange = function (open) {
    onOpenChange(open)
    if (!open) {
      setSearchQuery('')
            ...
            loadingRepos
              ...
              : filteredRepos.length === 0
                ? searchQuery.trim()
                  ? (0, jsx_runtime_1.jsxs)('div', {
                      className:
                        'space-y-3 py-6 text-center text-sm text-muted-foreground',
                      children: [
                        ...
                        (0, jsx_runtime_1.jsxs)('p', {
                          children: [
                            ...
                            (0, jsx_runtime_1.jsx)('a', {
                              ...
                              target: '_blank',
                              rel: 'noreferrer',
                              children: 'Configure the GitHub app',
                            }),
                            ' ',
                        ...
                        (0, jsx_runtime_1.jsx)('p', {
                          children:
                            'After updating the installation, reopen this dialog to search again.',
                        }),
                      ],
                    })
                  : (0, jsx_runtime_1.jsx)('div', {
                      ...
                      children: 'Start typing to search for repositories',
                    })
                : (0, jsx_runtime_1.jsx)('div', {
                    className: 'border rounded-md max-h-60 overflow-auto',
                    children: (0, jsx_runtime_1.jsx)('ul', {
                      className: 'divide-y',
                      children: filteredRepos.map(function (r) {
                          ...
                          'li',
                          {
                            ...
                            children: (0, jsx_runtime_1.jsxs)('div', {
                              ...
                              children: [
                                ...
                                (0, jsx_runtime_1.jsx)('span', {
                                  className:
                                    'flex-shrink-0 rounded-full border border-border px-2 py-0.5 text-xs font-medium text-muted-foreground',
                                  children: r.isPrivate ? 'Private' : 'Public',
                                }),
                              ],
                            }),
                          },
        ...
        (0, jsx_runtime_1.jsxs)(dialog_1.DialogFooter, {
          children: [
            ...
            (0, jsx_runtime_1.jsx)(button_1.Button, {
              ...
              children: enabling ? 'Connecting...' : 'Connect repository',
            }),
          ],
        }),
      ],
