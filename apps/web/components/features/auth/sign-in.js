...
function SignIn() {
  const _this = this
  const _a = (0, react_1.useState)(false),
    loading = _a[0],
    setLoading = _a[1]
  ...
  ;(0, react_1.useEffect)(
    function () {
      let _a
      if (
        ((_a = session.data) === null || _a === void 0 ? void 0 : _a.user) &&
        !session.isPending
      ) {
  ...
  return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {
    children: (0, jsx_runtime_1.jsx)(EmptyState_1.EmptyState, {
      ...
      action: (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
        children: [
