...
exports.VisuallyHidden = exports.DialogDescription = exports.DialogTitle = exports.DialogContent = exports.DialogClose = exports.DialogTrigger = exports.DialogOverlay = exports.DialogPortal = exports.Dialog = void 0;
...
var VisuallyHidden = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)("span", __assign({ ref: ref, className: (0, utils_1.cn)('sr-only', className) }, props)));
});
