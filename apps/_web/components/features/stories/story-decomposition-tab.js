  ...
  return (0, jsx_runtime_1.jsxs)('div', {
    ...
    children: [
      (0, jsx_runtime_1.jsxs)('div', {
        className: 'w-1/2 p-6 overflow-auto border-r',
        children: [
          (0, jsx_runtime_1.jsxs)('div', {
            ...
            children: [
              ...
              (0, jsx_runtime_1.jsx)(button_1.Button, {
                ...
                children: isDecomposing ? 'Transcribing...' : 'Re-transcribe',
              }),
            ],
          }),
          (0, jsx_runtime_1.jsx)('div', {
            ...
            children: decomposition
              ? (0, jsx_runtime_1.jsx)('pre', {
                  ...
                  children: JSON.stringify(decomposition, null, 2),
                })
              : (0, jsx_runtime_1.jsx)('div', {
                  className: 'text-sm text-muted-foreground',
                  children: 'No decomposition data available.',
                }),
          }),
        ],
      }),
      (0, jsx_runtime_1.jsx)('div', {
        className: 'w-1/2 p-6 overflow-auto',
        children: (0, jsx_runtime_1.jsx)(EmptyState_1.EmptyState, {
          kanji: '\u3052\u3093\u307D\u3093',
          kanjiTitle: 'Genpon - original source.',
          title: 'Backed by source',
          description:
            'View the source code and implementation details that back this intent composition. See how your stories are translated into actual code changes and understand the connection between intent and implementation.',
