...
function useStoryActions(_a) {
  ...
  const orgName = _a.orgName,
    ...
    storyId = _a.storyId,
    isCreateMode = _a.isCreateMode,
    storyName = _a.storyName,
    storyContent = _a.storyContent,
    originalStoryContent = _a.originalStoryContent,
    originalStoryName = _a.originalStoryName,
    hasContentChanges = _a.hasContentChanges,
    hasNameChanges = _a.hasNameChanges,
    createMore = _a.createMore,
    setStory = _a.setStory,
    setStoryName = _a.setStoryName,
    setStoryContent = _a.setStoryContent,
    setOriginalStoryContent = _a.setOriginalStoryContent,
    setOriginalStoryName = _a.setOriginalStoryName,
    _setCreateMore = _a.setCreateMore,
    setError = _a.setError,
    setIsSaving = _a.setIsSaving,
    setIsArchiving = _a.setIsArchiving,
    setIsTogglingState = _a.setIsTogglingState,
    setIsDecomposing = _a.setIsDecomposing,
    setIsTesting = _a.setIsTesting,
    setIsGenerating = _a.setIsGenerating,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            e_3 = _a.sent()
            setError(
              e_3 instanceof Error ? e_3.message : 'Failed to archive story',
            )
  ...
  const handleToggleState = function (newState) {
    return __awaiter(_this, void 0, void 0, function () {
      let result, e_4
      return __generator(this, function (_a) {
        switch (_a.label) {
  ...
  const handleDecompose = function () {
    return __awaiter(_this, void 0, void 0, function () {
      let resp, e_5
      return __generator(this, function (_a) {
        switch (_a.label) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            e_6 = _a.sent()
            setError(
              e_6 instanceof Error ? e_6.message : 'Failed to start test',
            )
            return [3 /*break*/, 5]
          case 4:
            setIsTesting(false)
  ...
  const handleApproveGenerated = function () {
    return __awaiter(_this, void 0, void 0, function () {
      let e_7
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            e_7 = _a.sent()
            setError(
              e_7 instanceof Error ? e_7.message : 'Failed to approve story',
            )
            setIsDecomposing(false)
            return [3 /*break*/, 4]
          case 4:
