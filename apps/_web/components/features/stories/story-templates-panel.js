...
function StoryTemplatesPanel(_a) {
  const onSelectTemplate = _a.onSelectTemplate
  const _b = (0, react_1.useState)(null),
    openTemplateId = _b[0],
    setOpenTemplateId = _b[1]
  return (0, jsx_runtime_1.jsxs)('div', {
    className: 'flex-1 flex flex-col overflow-hidden border rounded-md min-h-0',
    children: [
          ...
          (0, jsx_runtime_1.jsxs)('p', {
            ...
            children: [
              ...
              (0, jsx_runtime_1.jsx)('b', {
                children: 'free to write your story in any format you like',
              }),
              '. None of these are required, but you can use them as a starting point.',
            ],
          }),
        ],
      }),
      (0, jsx_runtime_1.jsx)('div', {
        ...
        children: STORY_TEMPLATES.map(function (template) {
          const isOpen = openTemplateId === template.id
          const contentId = 'story-template-'.concat(template.id)
                ...
                (0, jsx_runtime_1.jsxs)('div', {
                  ...
                  children: [
                    (0, jsx_runtime_1.jsxs)('button', {
                      type: 'button',
                      onClick() {
                        return setOpenTemplateId(isOpen ? null : template.id)
                      },
