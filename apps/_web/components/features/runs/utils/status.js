...
function getDisplayStatus(story) {
  let _a, _b
  return (_b =
    (_a = story.testResult) === null || _a === void 0 ? void 0 : _a.status) !==
    null && _b !== void 0
    ? _b
    : story.status
}
    ...
    startedAt:
      (_a =
        testResult === null || testResult === void 0
          ? void 0
          : testResult.startedAt) !== null && _a !== void 0
        ? _a
        : story.startedAt,
    completedAt:
      (_b =
        testResult === null || testResult === void 0
          ? void 0
          : testResult.completedAt) !== null && _b !== void 0
        ? _b
        : story.completedAt,
    durationMs:
      (_c =
        testResult === null || testResult === void 0
          ? void 0
          : testResult.durationMs) !== null && _c !== void 0
        ? _c
        : (testResult === null || testResult === void 0
              ? void 0
