  ...
  if (isMobile) {
    return (0, jsx_runtime_1.jsx)(
      ...
      __assign({ open: openMobile, onOpenChange: setOpenMobile }, props, {
        children: (0, jsx_runtime_1.jsxs)(sheet_1.SheetContent, {
          ...
          side: side,
          children: [
            (0, jsx_runtime_1.jsxs)(sheet_1.SheetHeader, {
              className: 'sr-only',
              children: [
...
function SidebarTrigger(_a) {
  ...
  return (0, jsx_runtime_1.jsxs)(
    ...
    __assign(
      ...
      {
        children: [
          (0, jsx_runtime_1.jsx)(lucide_react_1.PanelLeftIcon, {}),
...
function SidebarMenuButton(_a) {
  ...
  var _f = useSidebar(),
    ...
    state = _f.state
  var button = (0, jsx_runtime_1.jsx)(
    Comp,
    __assign(
      {
  ...
  return (0, jsx_runtime_1.jsxs)(tooltip_1.Tooltip, {
    children: [
