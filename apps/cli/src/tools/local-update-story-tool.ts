...
import { storySchema, type Story } from '../helpers/story-generator-agent.js'
import { writeLocalFile } from './local-write-file-tool.js'
...
const updateStoryInputSchema = z.object({
  ...
  story: storySchema.describe('The updated story object with enriched details.'),
})

export function createLocalUpdateStoryTool(ora?: Ora) {
  return tool({
    name: 'updateStory',
    description:
