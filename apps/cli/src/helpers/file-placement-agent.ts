...
- Source: ".kyoto/stories/filename.json" (the current file location)
- Target: ".kyoto/stories/directory-path/filename.json" (where it should go)
...
MANDATORY: You MUST call the moveFile tool to move the file from "${storyFile.path}" to the appropriate location in the hierarchy. The target path should be relative to the current working directory (e.g., ".kyoto/stories/users/preference/${storyFile.filename}").
